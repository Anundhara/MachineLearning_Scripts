...
final.dataset$TotalChg <- as.factor(final.dataset$TotalChg)
final.dataset$TotalPay <- as.factor(final.dataset$TotalPay)
...
final.dataset$SubscriberID <- as.factor(final.dataset$SubscriberID)

final.dataset$Decision <- as.factor(ifelse(final.dataset$RSN1 == 100, 100, 200))
final.dataset$RSN1 <- NULL
# final.dataset$ICN_DCN <- NULL
# final.dataset$PatientCtrlNum <- NULL
head(final.dataset)
